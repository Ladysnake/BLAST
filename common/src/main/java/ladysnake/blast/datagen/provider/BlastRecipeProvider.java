    ...
    protected RecipeProvider createRecipeProvider(HolderLookup.Provider registries, RecipeOutput output) {
        return new RecipeProvider(registries, output) {
            ...
            public void buildRecipes() {
                ...
                shaped(RecipeCategory.REDSTONE, BlastBlocks.BONESBURRIER).define('B', Items.BONE).define('R', Items.DYE.red()).define('H', Items.HONEY_BOTTLE).define('T', Items.TNT).define('P', Items.DYE.pink()).pattern("BRB").pattern("HTH").pattern("BPB").unlockedBy("has_tnt", has(Items.TNT)).save(output, "bonesburrier_from_tnt");
                shaped(RecipeCategory.REDSTONE, BlastBlocks.BONESBURRIER).define('B', Items.BONE).define('R', Items.DYE.red()).define('H', Items.HONEY_BOTTLE).define('G', BlastBlocks.GUNPOWDER_BLOCK).define('P', Items.DYE.pink()).pattern("BRB").pattern("HGH").pattern("BPB").unlockedBy("has_gunpowder", has(BlastBlocks.GUNPOWDER_BLOCK)).save(output, "bonesburrier_from_gunpowder_block");
