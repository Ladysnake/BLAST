...
import ladysnake.blast.common.entity.SmilesweeperEntity;
...
public class SmilesweeperBlock extends Block implements DetonatableBlock {
    public SmilesweeperBlock(Settings settings) {
        super(settings);
    }
    ...
    private static void prime(World world, BlockPos pos, LivingEntity igniter) {
        if (!world.isClient && world.getBlockState(pos).getBlock() instanceof SmilesweeperBlock) {
            SmilesweeperEntity entity = BlastEntities.SMILESWEEPER.create(world);
