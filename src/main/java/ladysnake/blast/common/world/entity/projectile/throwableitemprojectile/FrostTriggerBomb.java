...
public class FrostTriggerBomb extends TriggerBomb {
    public FrostTriggerBomb(EntityType<? extends Bomb> type, Level level) {
        super(type, level);
    ...
    public void explode() {
        super.explode();
        new EntityExplosion().spawnEntities(this, BlastEntityTypes.ICICLE, Math.round(getExplosionPower()), 1.4F);
    }
}
