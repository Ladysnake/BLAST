...
BLAST 1.13.9 - 26.1.2
------------------------------------------------------
- fix dirt bombs not working when lithium is installed

------------------------------------------------------
BLAST 1.13.8 - 26.1.2
------------------------------------------------------
- fix golden bombs not working when fortune doesn't exist
...
BLAST 1.13.3 - 1.21.5
------------------------------------------------------
- Fix bundles kicking the player when viewing their items
...
Update all thanks to MoriyaShiine!
- Update to 1.21.5
- Fix Icicles not incrementing frozen ticks properly
